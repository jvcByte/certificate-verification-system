              ...
              <div className="flex justify-between items-center">
                <Link href="/" className="flex items-center space-x-3 group">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-gray-500">Blockchain Verification</div>
                  </div>
                </Link>
                <div className="hidden md:flex items-center space-x-1">
                  <Link href="/admin/issue" className="px-4 py-2 rounded-lg hover:bg-purple-50 text-gray-700 hover:text-purple-600 transition-colors font-medium">
                    Issue
                  </Link>
                  <Link href="/admin/revoke" className="px-4 py-2 rounded-lg hover:bg-red-50 text-gray-700 hover:text-red-600 transition-colors font-medium">
                    Revoke
                  </Link>
                  <Link href="/student" className="px-4 py-2 rounded-lg hover:bg-green-50 text-gray-700 hover:text-green-600 transition-colors font-medium">
                    Student
                  </Link>
                  <Link href="/verify" className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:shadow-lg transition-all ml-2">
                    Verify
                  </Link>
                </div>
              </div>
